...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=7,da_board_cnt=1,da_bram_cntlr_cnt=5,da_clkrst_cnt=3,da_ps7_cnt=2,synth_mode=None}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:interrupt:1.0 INTR.IRQ_F2P_0 INTERRUPT" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME INTR.IRQ_F2P_0, PortWidth 1, SENSITIVITY LEVEL_HIGH" *) input [0:0]IRQ_F2P_0;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 UART_0_1 RxD" *) (* X_INTERFACE_MODE = "Master" *) input UART_0_1_rxd;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 UART_0_1 TxD" *) output UART_0_1_txd;
  input [31:0]addrb_0;
  ...
  design_1_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        ...
        .UART0_RX(UART_0_1_rxd),
        .UART0_TX(UART_0_1_txd));
