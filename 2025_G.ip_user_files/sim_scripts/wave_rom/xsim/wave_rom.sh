...
#
# Script generated by Vivado on Fri May 01 19:36:51 +0800 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : wave_rom.sh
...
#
# Usage        : wave_rom.sh
#                wave_rom.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                wave_rom.sh [-rerun]
#                wave_rom.sh [-reset_run]
#                wave_rom.sh [-clean]
#                wave_rom.sh [-reset_log]
#                wave_rom.sh [-help]
#
...
export RDI_DATADIR="D:/Tetro/Tools/Vivado/2025.2/Vivado/data"
...
# script info
echo -e "wave_rom.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./wave_rom.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot wave_rom xil_defaultlib.wave_rom xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim wave_rom -key {Behavioral:sim_1:Functional:wave_rom} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Tetro/Tools/Vivado/2025.2/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb wave_rom.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./wave_rom.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: wave_rom.sh [-help]\n\
Usage: wave_rom.sh [-step]\n\
Usage: wave_rom.sh [-lib_map_path]\n\
Usage: wave_rom.sh [-rerun]\n\
Usage: wave_rom.sh [-reset_run]\n\
Usage: wave_rom.sh [-clean]\n\
Usage: wave_rom.sh [-reset_log]\n\
Usage: wave_rom.sh [-keep_index]\n\
Usage: wave_rom.sh [-noclean_files]\n\n\
