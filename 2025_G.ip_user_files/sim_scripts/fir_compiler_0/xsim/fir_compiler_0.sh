...
#
# Script generated by Vivado on Thu Apr 30 21:41:44 +0800 2026
...
simulate()
{
  xsim fir_compiler_0 -key {Behavioral:sim_1:Functional:fir_compiler_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
