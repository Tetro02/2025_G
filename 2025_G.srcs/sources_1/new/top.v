module Test_Top  (
  ...
  // 38bit有符号数偏移量 2^37，用于38bit→8bit转换
  localparam signed OFFSET_37 = 38'sd137438953472;
  // 38bit有符号数最大值和最小值，用于饱和限幅（修复问题9）
  localparam signed DAC_DATA_MIN = -38'sd137438953472;
  localparam signed DAC_DATA_MAX =  38'sd137438953471;
